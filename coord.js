(function(root, factory) {
    if (typeof exports !== 'undefined') {
        ...
        define(['exports'], function(exports) {
            root.coord = factory(root, exports);
            return root.coord;
        });
    } else {
        root.coord = factory(root, {});
    }
}(typeof window === "object"? window: this, function(root, coord) {
    coord = {
        ...
        wgs_bd09: function (wgsLat, wgsLon) {
            var temp = this.gcj_encrypt(wgsLat, wgsLon);
